...
def _default_params_path():
    return os.path.join(os.path.dirname(os.path.abspath(__file__)), "params_beam3d_circle_bending.json")
...
def sofaRun(mesh_file, q, young_modulus, poisson_ratio):
    ...
    out_path = os.path.join(RESULTS_DIR, "sofa_beam3d_circle_bending_results.txt")
